...
{/* ประกาศบ้านยอดนิยม */}
        ...
        <div className="w-full text-center bg-slate-300 h-72">
          <div className="p-5"> 
            <h2 className="font-bold text-gray-600">ลงประกาศ ของกิน ที่ไหนดี เว็บไหนดี ต้อง BasProject.com</h2>
            <label className="text-gray-600">
              BasProject.com เป็นเว็บไซต์สำหรับลงประกาศขายของกิน โดยใช้งานฟรี ไม่มีค่าใช้จ่าย ทั้งที่อยู่ในกรุงเทพฯ และทั่วประเทศ
              ที่เว็บ BasProject.com เป็นพื้นที่ลงประกาศ ร้านอาหาร ซึ่งจะช่วยให้สามารถมีลูกค้าไปเสาะหาและลองทาน และหากใครที่กำลังมองหาร้านอาหาร ราคาถูก ไม่ว่าจะเป็น ภัตตาคาร หรือ ร้านอาหารที่เอาสัตว์เลี้ยงเข้าได้ ในทุกทำเลยอดนิยม จึงควรเลือกใช้บริการจากเรา โดย BasProject.com เป็นเว็บที่รู้จักอย่างแพร่หลายและมีผู้ใช้งานเป็นจำนวนมาก เนื่องจากเหตุผลดี ๆ ดังต่อไปนี้
            </label>
          </div>
